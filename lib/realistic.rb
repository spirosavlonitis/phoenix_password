module Realistic
	...
	def check_six(data)
		half_check_a=data[:combination].match(/[a-z]{3}[0-9]{3}/)
		half_check_b=data[:combination].match(/[0-9]{3}[a-z]{3}/)
	...
	def check_seven(data)
		...
		half_check_b=data[:combination].match(/[a-z]{3}[0-9]{4}/)
		half_check_c=data[:combination].match(/[0-9]{4}[a-z]{3}/)
		half_check_d=data[:combination].match(/[0-9]{3}[a-z]{4}/)
